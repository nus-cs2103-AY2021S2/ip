...
public class TaskListTest {
    ...
    void addTask() {
        ...
        try {
            ...
            todosList = taskList.addTodos(commandArgs).getTodosList();
    ...
    void addDeadline() {
        ...
        assert todosList != null;
        String rawMessage = todosList.get(0).map(Todo::getRawMessage).orElse("Something went wrong");
        String deadlineString = todosList.get(0).map(todo -> ((Deadline) todo).getDeadline()).orElse("Something went wrong");
        // rawMessage should be "hello world"
    ...
    void addEvent() {
        ...
        assert todosList != null;
        String rawMessage = todosList.get(0).map(Todo::getRawMessage).orElse("Something went wrong");
        String dateTimeString = todosList.get(0).map(todo -> ((Event) todo).getEventTime()).orElse("Something went wrong");
        // rawMessage should be "hello world"
