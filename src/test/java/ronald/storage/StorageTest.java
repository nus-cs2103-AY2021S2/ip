...
class StorageTest {
    ...
    @Test
    void initialiseList_initialListLength_success() throws RonaldException {
        String pathName = "./src/test/java/ronald/storage/test_data.txt";
    ...
    @Test
    void updateDataFile() throws RonaldException {
        String filePath = "./src/test/java/ronald/storage/test_data.txt";
