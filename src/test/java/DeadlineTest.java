...
public class DeadlineTest {
    ...
    public void testSaveTask() throws DukeException {
        assertEquals("D | 1 | return book | 2019-09-09", new Deadline("return book", true, "2019-09-09").saveTask());
        assertEquals("D | 0 | return book | 2019-09-09", new Deadline("return book", false, "2019-09-09").saveTask());
    }

    @Test
    public void testStringConversion() throws DukeException {
        assertEquals("[D][\u2713] return book (By: 9 Sep 2019)", new Deadline("return book", true, "2019-09-09").toString());
        assertEquals("[D][ ] return book (By: 9 Sep 2019)", new Deadline("return book", false, "2019-09-09").toString());
    }
}
