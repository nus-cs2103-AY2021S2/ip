...
public class TestDeadline {
    ...
    /**
     * Tests that the <code>Deadline</code> class processes the event's time correctly.
     */
    @Test
    ...
    /**
     * Tests that the <code>Deadline</code> class processes the task's status correctly.
     */
    @Test
