...
public class ModelForTest {
    ...
    static final TaskList TASKLIST_FOR_TEST = new TaskList();
    ...
    static final Parser PARSER_ERROR = Parser.createParser("unknown", TASKLIST_FOR_TEST);
    static final Parser PARSER_LIST = Parser.createParser("list", TASKLIST_FOR_TEST);
    static final Parser PARSER_TAG = Parser.createParser("tag 1 nice", TASKLIST_NOT_EMPTY);
    static final Parser PARSER_TODO = Parser.createParser("todo submit ip jar", TASKLIST_FOR_TEST);
    static final Parser PARSER_WRONG_DEADLINE =
            Parser.createParser("deadline return book /at Sunday", TASKLIST_FOR_TEST);
    static final Parser PARSER_WRONG_EVENT =
            Parser.createParser("event return book /by Sunday", TASKLIST_FOR_TEST);
