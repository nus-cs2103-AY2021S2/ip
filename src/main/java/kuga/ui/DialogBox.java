...
public class DialogBox extends HBox {
    ...
    /**
     * Creates a kuga dialogue box with the given user message text and the avatar icon.
     *
     * @param text Text message.
     * @param img Avatar icon image.
     * @return {@code DialogBox} representing a kuga reply.
     */
    public static DialogBox getKugaDialog(String text, Image img) {
