...
import kuga.commands.CommandResult;
...
import kuga.parser.Parser;
import kuga.storage.Storage;
import kuga.storage.StorageException;
...
public class MainWindow extends VBox {
    ...
    public void initialize() {
        ...
        kugaImage = new Image(getClass().getResourceAsStream("/images/kuga.png"));
    ...
    public void loadAdditionalConstraints() {
        ...
        dialogContainer.getChildren().add(DialogBox.getKugaDialog(welcomeMsg, kugaImage));
    ...
    private void handleUserInput() {
        ...
        dialogContainer.getChildren().addAll(
                ...
                DialogBox.getKugaDialog(response, kugaImage)
        );
        userInput.clear();
    }
