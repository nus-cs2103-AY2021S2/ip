...
import kuga.tasks.DeadlineTask;
import kuga.tasks.EventTask;
import kuga.tasks.Task;
import kuga.tasks.TaskList;
import kuga.tasks.ToDoTask;
import kuga.utils.OutputDateTimeFormat;

/**
 * Used to read and write to a file.
 */
public class Storage {
    private static final String DEFAULT_FILEPATH = "./data/kuga.txt";
