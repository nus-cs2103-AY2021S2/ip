...
public class Parser {
    ...
    public String ToDoCommand(String command) {
        String display = "";
    ...
    public String DeadlineCommand(String command) {
    ...
    public String EventCommand(String command) {
    ...
    public String DoneCommand(String command) {
    ...
    public String process() {
        ...
        if (command.contains("list")) {
            ...
            display = ToDoCommand(command);
        } else if (command.contains("deadline")) {
            display = DeadlineCommand(command);
        } else if (command.contains("event")) {
            display = EventCommand(command);
        } else if (command.contains("done")) {
            display = DoneCommand(command);
        } else if (command.contains("delete")) {
            display = DeleteCommand(command);
        } else if (command.contains("find")) {
            display = FindCommand(command);
        } else if (command.contains("bye")) {
            display = ByeCommand();
        } else {
            display = "OOPS, not sure what you have entered.";
        }
        return display;
    }
}
