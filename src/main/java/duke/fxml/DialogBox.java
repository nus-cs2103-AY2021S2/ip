...
public class DialogBox extends HBox {
    ...
    /**
     * Returns a user DialogBox from user text input and given image of user.
     *
    ...
    /**
     * Returns a duke DialogBox from response text and given image of duke.
     *
     * @param text Response text from user input.
