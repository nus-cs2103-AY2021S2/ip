...
public class DialogBox extends HBox {
    ...
    private VBox makeContent() {
        ...
        Paint background = isDuke ? Color.LIGHTBLUE : Color.GAINSBORO;
    ...
    /**
     * Constructs a system's dialog box.
     * @param text Text to be inserted into the dialog.
     * @return A system's dialog box.
     */
    public static DialogBox dukeDialogMaker(String text) {
        Label label = new Label(text);
        DialogBox temp = new DialogBox(label, true);
