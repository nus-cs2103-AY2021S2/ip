...
public class Main extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/Icebear.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/Icebear.png"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (nextCommand.equals("bye")) {
                ...
                try {
                    String[] processedText = iceBear.processCommand(nextCommand);
    ...
    public void start(Stage stage) {
        ...
        scrollPane.setPrefSize(500, 770);
