...
public class FileDataParser {
    ...
    private static Todo getTodoData(String input) throws DukeException {
    ...
    private static Deadline getDeadlineData(String input) throws DukeException {
    ...
    private static Event getEventData(String input) throws DukeException {
