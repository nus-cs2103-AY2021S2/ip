...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_TASK_NUM = "Oops! You have entered a task number: " +
            "%1$d, which is invalid! Please try again!";
    public static final String MESSAGE_INVALID_MIN_TASK_NUM = "Oops! Please at least give one task number";
    public static final String MESSAGE_INVALID_MIN_TASK_NUM_TYPE = "Oops! Only integers are valid task numbers!";
    public static final String MESSAGE_INVALID_DATE_TIME = "Oops! Please enter a valid date time format " +
            "[YYYY-MM-DD HH:MM]";
    public static final String MESSAGE_INVALID_COMMAND = "OOPS!!! I'm sorry, but I don't know what %1$s means :-(";
}
