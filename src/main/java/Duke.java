...
public class Duke extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/bunny.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/sloth.png"));
