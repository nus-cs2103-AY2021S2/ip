...
public class DialogBox extends HBox {
    ...
    /**
     * Returns a dialog box of Jhin with image view on the left and text on the right.
     *
     * @param text Text to be added to dialog box.
     * @param img Image to be added to dialog box.
     * @return Dialog box of Jhin.
     */
    public static DialogBox getJhinDialog(String text, Image img) {
