...
public class Event extends Todo {
     ...
     */
    private LocalDateTime parseStringToLocalDateTime(String eventDateTimeString) throws DateTimeParseException {
        return LocalDateTime.parse(
                eventDateTimeString.length() == 15 ? eventStringDateTime : String.format("0%s", eventStringDateTime),
                inputDateFormat);
    }
     ...
     * 
     * @return String containing event time of the Event, parsed from LocalDateTime
     *         object
     */
    public String getEventTime() {
        return this.eventDateTime.format(inputDateFormat).toString();
    }
     ...
     * 
     * @return String containing event time of the Event, parsed from LocalDateTime
     *         object in a prettier format
     */
    public String getPrettierEventTime() {
        return String.format("%s hrs", this.eventDateTime.format(outputDateFormat).toString());
    }
    ...
    public String getMessage() {
        return String.format("[E][%s] %s (at:%s)", this.getIsDoneIcon(), this.message, this.getPrettierEventTime());
    }
