...
public class Storage {
    ...
    /**
     * Attempt to retrieve a local save of the user's tasks on their pc as a list,
     * if not found, return the an empty list
     * 
     * @return List containing either existing Todos based on data file or an empty
     *         list
     */
