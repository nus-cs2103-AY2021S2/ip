...
public class DateTime {
     ...
     * @throws RonaldException if format of the date String is invalid.
     */
    public static LocalDateTime convertStringToDate(String date) throws RonaldException {
        try {
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yyyy HHmm");
            return LocalDateTime.parse(date, formatter);
        } catch (Exception e) {
            throw new RonaldException("There was something wrong with the format of your date and/or time.\n"
