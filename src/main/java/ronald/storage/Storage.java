...
import ronald.command.CommandType;
...
public class Storage {
     ...
     * @throws RonaldException if the formatting of Strings in the data file is incorrect.
     */
    private static Task convertStringToTask(String taskString) throws RonaldException {
        ...
        try {
            ...
            case EVENT:
                ...
                break;
            default:
                throw new RonaldException("Can't convert string from menu to order...");
            }
            if (isDone) {
                task.markDone();
            }
            ...
            throw new RonaldException("There seems to be something wrong with the menu and we can't start up...");
        }
    }
     ...
     *
     * @throws RonaldException if the data file cannot be written into.
     */
    public static void updateDataFile() throws RonaldException {
        try {
            ...
            throw new RonaldException("Oh no! I can't seem to update your menu...");
        }
    }
}
